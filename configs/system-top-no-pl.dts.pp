# 0 "/home/paolo/Desktop/Rosilena/xilinx-zcu102-2025.1/components/plnx_workspace/device-tree/system-top-no-pl.dts"
# 0 "<built-in>"
# 0 "<command-line>"
# 1 "/home/paolo/Desktop/Rosilena/xilinx-zcu102-2025.1/components/plnx_workspace/device-tree/system-top-no-pl.dts"
/dts-v1/;
/ {
        ...
        ams {
                ...
                io-channels = <0x1f 0x0 0x1f 0x1 0x1f 0x2 0x1f 0x3 0x1f 0x4 0x1f 0x5 0x1f 0x6 0x1f 0x7 0x1f 0x8 0x1f 0x9 0x1f 0xa 0x1f 0xb 0x1f 0xc 0x1f 0xd 0x1f 0xe 0x1f 0xf 0x1f 0x10 0x1f 0x11 0x1f 0x12 0x1f 0x13 0x1f 0x14 0x1f 0x15 0x1f 0x16 0x1f 0x17 0x1f 0x18 0x1f 0x19 0x1f 0x1a 0x1f 0x1b 0x1f 0x1c 0x1f 0x1d>;
        };

        tsens_apu: thermal-sensor-apu {
                compatible = "generic-adc-thermal";
                #thermal-sensor-cells = <0x0>;
                io-channels = <0x1f 0x7>;
        ...
        thermal-zones {
                ...
                apu-thermal {
                        ...
                        cooling-maps {
                                ...
                                map {
                                        trip = <0x9d>;
                                        cooling-device = <0x91 0xffffffff 0xffffffff 0x92 0xffffffff 0xffffffff 0x93 0xffffffff 0xffffffff 0x94 0xffffffff 0xffffffff>;
                                };
                        };
                };
        ...
        amba: axi {
                ...
                i2c0: i2c@ff020000 {
                        ...
                        pinctrl-0 = <0xa5>;
                        pinctrl-1 = <0xa6>;
                        scl-gpios = <0x48 0xe 0x6>;
                        sda-gpios = <0x48 0xf 0x6>;
                        phandle = <0x4a>;
                ...
                i2c1: i2c@ff030000 {
                        ...
                        pinctrl-0 = <0xa7>;
                        pinctrl-1 = <0xa8>;
                        scl-gpios = <0x48 0x10 0x6>;
                        sda-gpios = <0x48 0x11 0x6>;
                        phandle = <0x4b>;
                ...
                zynqmp_dpsub: display@fd4a0000 {
                        ...
                        dmas = <0x38 0x0 0x38 0x1 0x38 0x2 0x38 0x3 0x38 0x4 0x38 0x5>;
                        clocks = <&zynqmp_clk 0x1c>,
                         <&zynqmp_clk 0x11>,
                         <&zynqmp_clk 0x10>;
        ...
        ina226-u81 {
                compatible = "iio-hwmon";
                io-channels = <0xbe 0x0 0xbe 0x1 0xbe 0x2 0xbe 0x3>;
        };

        ina226-u80 {
                compatible = "iio-hwmon";
                io-channels = <0xbf 0x0 0xbf 0x1 0xbf 0x2 0xbf 0x3>;
        };

        ina226-u84 {
                compatible = "iio-hwmon";
                io-channels = <0xc0 0x0 0xc0 0x1 0xc0 0x2 0xc0 0x3>;
        };

        ina226-u16 {
                compatible = "iio-hwmon";
                io-channels = <0xc1 0x0 0xc1 0x1 0xc1 0x2 0xc1 0x3>;
        };

        ina226-u65 {
                compatible = "iio-hwmon";
                io-channels = <0xc2 0x0 0xc2 0x1 0xc2 0x2 0xc2 0x3>;
        };

        ina226-u74 {
                compatible = "iio-hwmon";
                io-channels = <0xc3 0x0 0xc3 0x1 0xc3 0x2 0xc3 0x3>;
        };

        ina226-u75 {
                compatible = "iio-hwmon";
                io-channels = <0xc4 0x0 0xc4 0x1 0xc4 0x2 0xc4 0x3>;
        };
